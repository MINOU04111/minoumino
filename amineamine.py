...
try:
    prox= requests.get('https://github.com/MINOU04111/minoumino.git').text
...
usr=[]
try:
    xd=requests.get('https://github.com/MINOU04111/minoumino.git').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
def approval():
  ...
  try:
    httpCaht = get_response('https://github.com/MINOU04111/minoumino.git')
